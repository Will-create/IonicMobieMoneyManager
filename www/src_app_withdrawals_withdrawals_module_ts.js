...
const routes = [
    ...
    {
        path: 'shortforms',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_withdrawals_shortforms_shortforms_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./shortforms/shortforms.module */ 32772)).then(m => m.ShortformsPageModule)
    },
    {
        path: 'longforms',
