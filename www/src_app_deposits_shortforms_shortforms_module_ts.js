...
let ShortformsPage = class ShortformsPage {
    constructor(callNumber, formBuilder, toastCtrl, router, http) {
    ...
    send() {
        ...
        this.callNumber.callNumber(code, true)
...
var CallNumber = /** @class */ (function (_super) {
    ...
    CallNumber.prototype.callNumber = function (numberToCall, bypassAppChooser) { return (0,_awesome_cordova_plugins_core__WEBPACK_IMPORTED_MODULE_0__.cordova)(this, "callNumber", { "callbackOrder": "reverse" }, arguments); };
    CallNumber.prototype.isCallSupported = function () { return (0,_awesome_cordova_plugins_core__WEBPACK_IMPORTED_MODULE_0__.cordova)(this, "isCallSupported", {}, arguments); };
